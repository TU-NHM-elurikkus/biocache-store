            ...
            */
            ...
            if (nameMetrics != null) {
                ...
                if (nsr != null) {
                    ...
                    logger.debug(
                        s"[QualityAssertion] A homonym was detected (with no higher level match); " +
                        s"Classification for Kingdom: ${raw.classification.kingdom}, " +
                        s"Family: ${raw.classification.family}, " +
                        s"Genus: ${raw.classification.genus}, " +
                        s"Species: ${raw.classification.species}, " +
                        s"Epithet: ${raw.classification.specificEpithet}")
                    ...
                    logger.debug(
                        s"[QualityAssertion] No match for record; " +
                        s"Classification for Kingdom: ${raw.classification.kingdom}, " +
                        s"Family: ${raw.classification.family}, " +
                        s"Genus: ${raw.classification.genus}, " +
                        s"Species: ${raw.classification.species}, " +
